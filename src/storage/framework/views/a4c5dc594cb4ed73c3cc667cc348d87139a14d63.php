...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">
                                <?php echo e(__('auth.E-Mail Address')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="checkpoint" class="col-md-4 col-form-label text-md-right"><?php echo e(__
                            ('auth.Border Checkpoint')); ?></label>

                            <div class="col-md-6">
                                <select id="checkpoint" name="checkpoint" class="form-control">
                                    <option value="" selected disabled style="display:none"><?php echo e(__
