            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @if ( Auth::user()->username !== env('ADMIN_USER') )
                            <div class="float-right">
                                <a href="javascript:void(0);" id="print-declaration"
                                                ...
                                                <td width="70%">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="dsp-measure"
                                                            ...
                                                            {{ (is_null($declaration['dsp_measure']) ||
                                    ...
                                    <div class="col-md-9 text-left">
                                        <table class="table table-sm table-borderless">
                                            @if ( app()->getLocale() === 'ro' )
                                                <tr>
                                                    <td>
                                                        {{ __('app.Name in declaration') }}: <strong
                                                            class="text-uppercase">{{ $declaration['name'] }}</strong>
                                                        &nbsp;&nbsp;
                                                        {{ __('app.Surname') }}: <strong
                                                            class="text-uppercase">{{ $declaration['surname'] }}</strong>
                                                    </td>
                                                </tr>
                                            @else
                                                <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    &nbsp;{{ __('app.Year') }}
                                                    <strong>{{ $declaration['birth_date_year'] }}</strong>,
                                                    &nbsp;{{ __('app.Month') }}
                                                    <strong>{{ $declaration['birth_date_month'] }}</strong>,
                                                    &nbsp;{{ __('app.Day') }}
                                                    <strong>{{ $declaration['birth_date_day'] }}</strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-justify">
                                        ...
                                        <p class="no-margin-bottom">
                                            ...
                                            {{ __('app.Table Phone') }}:
                                            <strong>{{ $declaration['phone'] }}</strong><br/>
                                        </p>
                                    </div>
                                </div>
                                <hr class="sub-section">
